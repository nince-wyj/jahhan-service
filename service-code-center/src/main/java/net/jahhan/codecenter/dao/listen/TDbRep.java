 ...
 */
 @Singleton
public class TDbRep extends AbstractSmpTTLCountRepository implements DBEventListener{

	private final static String PRE = BaseConfiguration.SERVICE + "_TDbRep_";
	...
	public void listen(EventObject event) {
		onListen(event,TDb.class);
	}

	@Override
	public String[] getTags() {
		return TagUtil.getTags(TDb.class);
	}
}
